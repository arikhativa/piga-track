			...
			<div className="flex h-full items-center gap-2">
				...
				{onClear ? (
					<>
						<Separator
							orientation="vertical"
							className="h-full text-background"
						/>

						{/** biome-ignore lint/a11y/useSemanticElements: not sure what else i can do */}
						<div
							role="button"
							tabIndex={0}
							className="pointer-events-auto cursor-pointer p-1 text-muted-foreground  "
							onPointerDown={(e) => {
								e.preventDefault();
								e.stopPropagation();
							}}
