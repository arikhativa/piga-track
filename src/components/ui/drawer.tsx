  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-oklch(1 0 0) fixed z-50 flex h-auto flex-col dark:bg-oklch(0.145 0.008 326)",
        ...
        {...props}
      >
        <div className="bg-oklch(0.96 0.003 325.6) mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:bg-oklch(0.263 0.024 320.12)" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
