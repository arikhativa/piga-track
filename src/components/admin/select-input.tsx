    ...
    <>
      ...
      >
        ...
        <div className="relative">
          ...
          >
            <SelectTrigger
              className={cn("w-full transition-all hover:bg-oklch(0.96 0.003 325.6) dark:hover:bg-oklch(0.263 0.024 320.12)")}
            ...
            >
              ...
              {field.value && field.value !== emptyValue ? (
                <div
                  role="button"
                  className="p-0 ms-auto pointer-events-auto hover:bg-transparent text-oklch(0.542 0.034 322.5) opacity-50 hover:opacity-100 dark:text-oklch(0.711 0.019 323.02)"
                  onClick={handleReset}
                >
                  <X className="h-4 w-4" />
                </div>
