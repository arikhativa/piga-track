...
function FormLabel({
	...
	return (
		<Label
			...
			data-error={!!error}
			className={cn(
				"data-[error=true]:text-oklch(0.577 0.245 27.325) dark:data-[error=true]:text-oklch(0.704 0.191 22.216)",
				className,
			)}
			htmlFor={formItemId}
			{...props}
...
function FormDescription({ className, ...props }: React.ComponentProps<"p">) {
	...
	return (
		<div
			...
			className={cn(
				"text-oklch(0.542 0.034 322.5) text-sm dark:text-oklch(0.711 0.019 323.02)",
				className,
			)}
			{...props}
		/>
...
const FormError = ({ className, ...props }: React.ComponentProps<"p">) => {
	...
	return (
		<p
			...
			id={formMessageId}
			className={cn(
				"text-oklch(0.577 0.245 27.325) text-sm dark:text-oklch(0.704 0.191 22.216)",
				className,
			)}
			{...props}
		>
